...
{
    public class RelativeHumidityHumidifierThresholdCharacteristic: Characteristic
    {
      public const string Uuid = "000000CA-0000-1000-8000-0026BB765291";

    

        public RelativeHumidityHumidifierThresholdCharacteristic(): base(
