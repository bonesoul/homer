...
{
    public class SulphurDioxideDensityCharacteristic: Characteristic
    {
      public const string Uuid = "000000C5-0000-1000-8000-0026BB765291";

    

        public SulphurDioxideDensityCharacteristic(): base(
