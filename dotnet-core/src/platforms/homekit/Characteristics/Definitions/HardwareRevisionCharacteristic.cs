...
{
    public class HardwareRevisionCharacteristic: Characteristic
    {
      public const string Uuid = "00000053-0000-1000-8000-0026BB765291";

    

        public HardwareRevisionCharacteristic(): base(
