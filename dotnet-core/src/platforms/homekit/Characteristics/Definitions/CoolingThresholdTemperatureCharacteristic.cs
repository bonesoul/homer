...
{
    public class CoolingThresholdTemperatureCharacteristic: Characteristic
    {
      public const string Uuid = "0000000D-0000-1000-8000-0026BB765291";

    

        public CoolingThresholdTemperatureCharacteristic(): base(
