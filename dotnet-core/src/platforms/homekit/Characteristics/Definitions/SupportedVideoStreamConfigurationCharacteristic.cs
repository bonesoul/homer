...
{
    public class SupportedVideoStreamConfigurationCharacteristic: Characteristic
    {
      public const string Uuid = "00000114-0000-1000-8000-0026BB765291";

    

        public SupportedVideoStreamConfigurationCharacteristic(): base(
