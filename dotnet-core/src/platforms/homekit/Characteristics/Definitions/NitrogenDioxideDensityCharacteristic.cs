...
{
    public class NitrogenDioxideDensityCharacteristic: Characteristic
    {
      public const string Uuid = "000000C4-0000-1000-8000-0026BB765291";

    

        public NitrogenDioxideDensityCharacteristic(): base(
