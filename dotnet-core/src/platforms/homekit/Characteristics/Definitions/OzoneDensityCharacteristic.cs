...
{
    public class OzoneDensityCharacteristic: Characteristic
    {
      public const string Uuid = "000000C3-0000-1000-8000-0026BB765291";

    

        public OzoneDensityCharacteristic(): base(
