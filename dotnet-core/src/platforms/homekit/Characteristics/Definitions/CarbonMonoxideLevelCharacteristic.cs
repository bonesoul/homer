...
{
    public class CarbonMonoxideLevelCharacteristic: Characteristic
    {
      public const string Uuid = "00000090-0000-1000-8000-0026BB765291";

    

        public CarbonMonoxideLevelCharacteristic(): base(
