...
{
    public class MotionDetectedCharacteristic: Characteristic
    {
      public const string Uuid = "00000022-0000-1000-8000-0026BB765291";

    

        public MotionDetectedCharacteristic(): base(
