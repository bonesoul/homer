...
{
    public class TargetTiltAngleCharacteristic: Characteristic
    {
      public const string Uuid = "000000C2-0000-1000-8000-0026BB765291";

    

        public TargetTiltAngleCharacteristic(): base(
