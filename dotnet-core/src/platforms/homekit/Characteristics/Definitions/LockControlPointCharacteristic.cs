...
{
    public class LockControlPointCharacteristic: Characteristic
    {
      public const string Uuid = "00000019-0000-1000-8000-0026BB765291";

    

        public LockControlPointCharacteristic(): base(
