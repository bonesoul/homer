...
{
    public class TargetHorizontalTiltAngleCharacteristic: Characteristic
    {
      public const string Uuid = "0000007B-0000-1000-8000-0026BB765291";

    

        public TargetHorizontalTiltAngleCharacteristic(): base(
