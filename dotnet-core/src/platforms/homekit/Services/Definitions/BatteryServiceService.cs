...
namespace Homer.Platform.HomeKit.Services.Definitions
{
    ...
    {
      public const string Uuid = "00000096-0000-1000-8000-0026BB765291";

        public BatteryServiceService()
            : base("00000096-0000-1000-8000-0026BB765291", "Battery Service")
        {
          // required characteristics
            AddCharacteristic(typeof(BatteryLevelCharacteristic))
              .AddCharacteristic(typeof(ChargingStateCharacteristic))
