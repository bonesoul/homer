...
namespace Homer.Platform.HomeKit.Services.Definitions
{
    ...
    {
      public const string Uuid = "00000113-0000-1000-8000-0026BB765291";

        public SpeakerService()
            : base("00000113-0000-1000-8000-0026BB765291", "Speaker")
        {
          // required characteristics
            AddCharacteristic(typeof(MuteCharacteristic))
              ;

          // optional characteristics
            AddOptionalCharacteristic(typeof(NameCharacteristic))
              .AddOptionalCharacteristic(typeof(VolumeCharacteristic))
              ;
        }
    }
}
