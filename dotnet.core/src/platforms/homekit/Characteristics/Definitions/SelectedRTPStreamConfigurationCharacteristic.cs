...
{
    public class SelectedRTPStreamConfigurationCharacteristic: Characteristic
    {
      public const string Uuid = "00000117-0000-1000-8000-0026BB765291";

    

        public SelectedRTPStreamConfigurationCharacteristic(): base(
