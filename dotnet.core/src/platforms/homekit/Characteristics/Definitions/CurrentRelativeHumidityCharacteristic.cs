...
{
    public class CurrentRelativeHumidityCharacteristic: Characteristic
    {
      public const string Uuid = "00000010-0000-1000-8000-0026BB765291";

    

        public CurrentRelativeHumidityCharacteristic(): base(
