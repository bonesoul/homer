...
{
    public class HeatingThresholdTemperatureCharacteristic: Characteristic
    {
      public const string Uuid = "00000012-0000-1000-8000-0026BB765291";

    

        public HeatingThresholdTemperatureCharacteristic(): base(
