...
{
    public class CarbonDioxidePeakLevelCharacteristic: Characteristic
    {
      public const string Uuid = "00000094-0000-1000-8000-0026BB765291";

    

        public CarbonDioxidePeakLevelCharacteristic(): base(
