...
{
    public class HoldPositionCharacteristic: Characteristic
    {
      public const string Uuid = "0000006F-0000-1000-8000-0026BB765291";

    

        public HoldPositionCharacteristic(): base(
