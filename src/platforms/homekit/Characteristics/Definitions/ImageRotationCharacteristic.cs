...
{
    public class ImageRotationCharacteristic: Characteristic
    {
      public const string Uuid = "0000011E-0000-1000-8000-0026BB765291";

    

        public ImageRotationCharacteristic(): base(
