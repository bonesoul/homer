...
{
    public class PM2_5DensityCharacteristic: Characteristic
    {
      public const string Uuid = "000000C6-0000-1000-8000-0026BB765291";

    

        public PM2_5DensityCharacteristic(): base(
