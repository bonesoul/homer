...
{
    public class CurrentVerticalTiltAngleCharacteristic: Characteristic
    {
      public const string Uuid = "0000006E-0000-1000-8000-0026BB765291";

    

        public CurrentVerticalTiltAngleCharacteristic(): base(
