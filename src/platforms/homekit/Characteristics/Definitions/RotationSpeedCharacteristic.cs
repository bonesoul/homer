...
{
    public class RotationSpeedCharacteristic: Characteristic
    {
      public const string Uuid = "00000029-0000-1000-8000-0026BB765291";

    

        public RotationSpeedCharacteristic(): base(
