...
{
    public class TargetRelativeHumidityCharacteristic: Characteristic
    {
      public const string Uuid = "00000034-0000-1000-8000-0026BB765291";

    

        public TargetRelativeHumidityCharacteristic(): base(
