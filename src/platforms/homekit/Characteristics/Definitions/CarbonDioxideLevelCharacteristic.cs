...
{
    public class CarbonDioxideLevelCharacteristic: Characteristic
    {
      public const string Uuid = "00000093-0000-1000-8000-0026BB765291";

    

        public CarbonDioxideLevelCharacteristic(): base(
