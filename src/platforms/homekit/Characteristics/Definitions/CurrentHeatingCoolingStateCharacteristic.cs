...
{
    public class CurrentHeatingCoolingStateCharacteristic: Characteristic
    {
      public const string Uuid = "0000000F-0000-1000-8000-0026BB765291";
        ...
        public CurrentHeatingCoolingStateCharacteristic(): base(
