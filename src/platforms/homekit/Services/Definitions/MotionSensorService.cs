...
{
    public class MotionSensorService: Service
    {
      public const string Uuid = "00000085-0000-1000-8000-0026BB765291";

        public MotionSensorService()
            : base("00000085-0000-1000-8000-0026BB765291", "Motion Sensor")
        {
